#! d:/Program Files/Ruby/Ruby193/bin/ruby.exe -sWKu
# -*- coding: utf-8 -*-
...
module EnClient
  ...
  EVERNOTE_HOST       =  "www.evernote.com"     #"app.yinxiang.com"                             #"www.evernote.com"
  ...
  class CreateNoteCommand < Command
    ...
    def exec_impl
      ...
      @title.force_encoding Encoding::UTF_8   #add by weng
  ...
  class UpdateNoteCommand < Command
    ...
    def exec_impl
      ...
      @content.force_encoding Encoding::UTF_8 #froce enco
